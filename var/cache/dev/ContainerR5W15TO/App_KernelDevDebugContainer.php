...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('K+xROVxd6H', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kjT6sEkyhz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getConsole_CommandLoaderService()
    {
        ...
        return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\View\\LeapYearConsole' => ['privates', 'App\\View\\LeapYearConsole', 'getFizzBuzzConsoleService', false],
            ...
            'App\\View\\LeapYearConsole' => 'App\\View\\LeapYearConsole',
    ...
    /**
     * Gets the private 'App\View\FizzBuzzConsole' shared autowired service.
     *
     * @return \App\View\LeapYearConsole
     */
    protected function getFizzBuzzConsoleService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/View/FizzBuzzConsole.php';

        $this->privates['App\\View\\LeapYearConsole'] = $instance = new \App\View\LeapYearConsole();

        $instance->setName('app:launch');
